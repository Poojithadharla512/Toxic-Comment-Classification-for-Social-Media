...
loaded = CountVectorizer(decode_error='replace',vocabulary=pickle.load(open(r'C:/Users/dharl/Desktop/Major/Major document/5. Project Execution Files-20241129T161337Z-001/flask/word_feats.pkl','rb')))
